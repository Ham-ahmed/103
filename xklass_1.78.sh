...
echo -e "${CYAN}"
echo "################################################################"
echo "#         Start downloading and installing  xklass_1.78        #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/103/refs/heads/main/enigma2-plugin-extensions-xklass_1.78.20260308_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xklass_1.78.20260308_all.ipk"
