...
echo -e "${CYAN}"
echo "################################################################"
echo "#         Start downloading and installing  estalker_1.30      #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/103/refs/heads/main/enigma2-plugin-extensions-estalker_1.30.20260307_all.ipk"
IPK_NAME="enigma2-plugin-extensions-estalker_1.30.20260307_all.ipk"
